...
const UserSelection = () => {
  ...
  return (
    <div className="mt-3">
      <h5 className="p-3 custom-border rounded-3 d-flex align-items-center gap-2">
        <IoSettingsOutline /> User role settings
      </h5>
      {/* User Role */}
      <div className="d-flex w-25 mt-3 justify-content-center align-items-center gap-2">
