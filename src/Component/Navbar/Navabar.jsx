...
const Navbar = () => {
  ...
  return (
    <nav className="d-flex gap-3 bg-white position-sticky pt-3 pe-3 pb-3 top-0   justify-content-end align-items-center custom-bg-main text-white text-end w-100">
