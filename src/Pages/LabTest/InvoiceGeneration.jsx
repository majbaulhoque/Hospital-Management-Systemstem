        ...
        <div className="invoice-container border p-3 my-5 rounded-3 shadow-lg container">
                ...
                <div className='d-flex flex-wrap justify-content-between'>
                    <div className="col-12 col-sm-6 col-md-6 col-lg-3 mb-3">
                        <Form.Group className="d-md-flex " controlId="billNumber">
                            ...
                            <Form.Control type="number" placeholder="Bill No" className='w-50 p-2' />
                        </Form.Group>
                    </div>
                    <div className="col-12 col-sm-6 col-md-6 col-lg-3 mb-3">
            ...
            <div className='d-flex flex-column flex-md-row gap-2'>
                <div className='border shadow col-12 col-md-6 px-2'>
                    <Form.Group className="d-flex flex-column flex-md-row my-3" controlId="patientName">
                    ...
                    <Form.Group className="d-flex flex-column flex-md-row my-3" controlId="address">
                    ...
                    <Form.Group className="d-flex flex-column flex-md-row my-3" controlId="contactNo">
                    ...
                    <Form.Group className="d-flex flex-column flex-md-row my-3" controlId="regNo">
                    ...
                    <div className='d-flex flex-column flex-md-row'>
                        <Form.Group className="d-flex flex-column flex-md-row my-3 col-md-6" controlId="age">
                        ...
                        <Form.Group className="d-flex flex-column flex-md-row my-3 col-md-6" controlId="gender">
                    ...
                    <div className='d-flex flex-column flex-md-row'>
                        <Form.Group className="d-flex flex-column flex-md-row my-3 col-md-6" controlId="district">
                        ...
                        <Form.Group className="d-flex flex-column flex-md-row my-3 col-md-6" controlId="union">
                ...
                <div className="col-12 col-md-6 col-lg-6 border rounded shadow p-3">
                    <Form.Group className="d-flex flex-column flex-md-row" controlId="docTitle">
                    ...
                    <Form.Group className="d-flex flex-column flex-md-row my-3" controlId="refIdDoctor">
                    ...
                    <Form.Group className="d-flex flex-column flex-md-row my-3" controlId="qualification">
                    ...
                    <Form.Group className="d-flex flex-column flex-md-row my-3" controlId="docCode">
                    ...
                    <Form.Group className="d-flex flex-column flex-md-row my-3" controlId="docAddress">
                    ...
                    <div className="row">
                        <div className="col-12 col-md-5">
                            <Form.Group className="d-flex mb-3" controlId="totalAmount">
                                ...
                                <Form.Control type="number" placeholder="Total Amount" className="w-75 p-2" />
                            </Form.Group>
                        </div>
                        <div className="col-12 col-md-6">
                            <Form.Group className="d-flex mb-3" controlId="discount1">
                                <Form.Label className="fw-bold m-2 col-3">Discount :</Form.Label>
                                <Form.Control type="number" placeholder="Discount" className="w-75 p-2" />
                            </Form.Group>
                        </div>
                    </div>
                    <div className="row">
                        ...
                        <div className="col-12 col-md-6">
                            <Form.Group className="d-flex mb-3" controlId="netPayable1">
                                <Form.Label className="fw-bold m-2 col-3">Net Payable :</Form.Label>
                                <Form.Control type="number" placeholder="Net Payable" className="w-75 p-2" />
                            </Form.Group>
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-12 col-md-5">
                            <Form.Group className="d-flex mb-3" controlId="amountPaid">
                                ...
                                <Form.Control type="number" placeholder="Amount Paid" className="w-75 p-2" />
                            </Form.Group>
                        </div>
                        <div className="col-12 col-md-6">
                            <Form.Group className="d-flex mb-3" controlId="dueAmount">
                                <Form.Label className="fw-bold m-2 col-3">Due :</Form.Label>
                                <Form.Control type="number" placeholder="Due Amount" className="w-75 p-2" />
                            </Form.Group>
                        </div>
                    </div>
                </div>
